...
export default function FinancialsAnalyticsPage() {
  ...
  // Data state - NEW: Using view data instead of raw cases
  ...
  // Calculate metrics using custom hook - NEW: Pass view data
  ...
  // Fetch data - NEW: Query from views instead of raw cases
