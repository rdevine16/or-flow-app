...
function makeAnalytics(overrides: Partial<AnalyticsOverview> = {}): AnalyticsOverview {
  return {
    ...
    standardSurgicalTurnover: makeKPIResult({ value: 40, displayValue: '40 min', target: 45, targetMet: true }),
    flipRoomTime: makeKPIResult({ value: 12, displayValue: '12 min', target: 15, targetMet: true }),
    flipRoomAnalysis: [],
