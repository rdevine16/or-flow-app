// app/settings/integrations/cerner/PageClient.tsx
// Oracle Cerner HL7v2 Integration hub — Overview | Review Queue | Mappings | Logs
// Uses shared integration components with Cerner-specific config
...
const log = logger('cerner-integration-page')

const systemConfig = getSystemConfig('cerner_hl7v2')
...
export default function CernerHL7v2IntegrationPage() {
