// app/settings/integrations/meditech/mappings/PageClient.tsx
// MEDITECH HL7v2 Entity mapping manager — Surgeons | Rooms | Procedures sub-tabs
...
export default function MeditechEntityMappingsPage() {
  ...
  const { data: integration, loading: integrationLoading } = useSupabaseQuery<EhrIntegration | null>(
    async (supabase) => {
      const { data } = await ehrDAL.getIntegrationByFacility(supabase, facilityId!, 'meditech_hl7v2')
      return data
    },
    ...
    return (
      <div className="space-y-4">
        <div className="flex items-center gap-3 mb-6">
          <button onClick={() => router.push('/settings/integrations/meditech')} className="p-1.5 hover:bg-slate-100 rounded-lg transition-colors">
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-8 text-center">
          ...
          <p className="text-slate-500">No MEDITECH HL7v2 integration found. Set up the integration first to manage mappings.</p>
          <button
            onClick={() => router.push('/settings/integrations/meditech')}
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-semibold text-slate-900">Entity Mappings</h1>
          <p className="text-slate-500 text-sm">HL7v2 entity mappings (MEDITECH &rarr; ORbit)</p>
        </div>
      </div>
