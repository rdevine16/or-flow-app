...
type GateMode = 'hide' | 'lock' | 'blur' | 'blur-compact' | 'locked-tab'
...
function renderTierDenied(
  ...
  switch (mode) {
    ...
    case 'blur-compact':
      return (
        <BlurredCompact requiredTier={requiredTier}>
          {children}
        </BlurredCompact>
      )
...
// ============================================
// Blur-compact mode — blurred with small lock icon only (no text)
// ============================================

function BlurredCompact({
  requiredTier,
  children,
}: {
  requiredTier: TierSlug
  ...
  return (
    <div className="relative overflow-hidden rounded-xl">
      ...
      >
        <div className="flex h-8 w-8 items-center justify-center rounded-full bg-slate-900/10 backdrop-blur-sm">
