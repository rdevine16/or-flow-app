...
const MOCK_CASE_DETAIL: CaseDetail = {
  ...
  procedure_type: { id: 'pt-1', name: 'Total Hip Replacement', procedure_category_id: 'cat-ortho', expected_duration_minutes: 90 },
  case_completion_stats: { total_duration_minutes: 95 },
  patient_dob: null,
  patient_phone: null,
  laterality: null,
