...
// ORbit Logo Component - Full logo, scales with container
const OrbitLogo = ({ className = "h-7" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 726 497" fill="none" xmlns="http://www.w3.org/2000/svg">
    {/* Orbital O with small circle */}
    <path 
      d="M331.34,479c83.46-4.13,157.32-52.48,194.68-126.83,1.71-3.4,5.17-4.74,8.39-3.57,3.14,1.14,5.51,5.2,3.76,8.72-18.2,36.64-45.34,68.21-78.97,91.63-38.39,26.73-83.48,41.54-130.25,43.39-29.69,1.17-59.54-2.85-87.48-12.71l-3.99-1.41-3.51-1.26c-67.14-24.19-119.72-78.57-144.08-145.75-48.96,3.8-86.96-35.63-85.87-83.73.16-37.53,24.27-71.32,61.26-80.2,8.18-1.96,16.29-2.4,24.71-2.12C124,71.89,211.19,7.93,310.53,4.29c6.14-.54,11.8-.2,17.53,0,88.67,2.89,168.52,53.61,208.91,132.53,1.68,3.27,1.02,7.32-2.49,9.22-3.76,2.03-7.58.09-9.38-3.42-35.75-69.74-104.38-117.1-182.48-124.14l-3.78-.34c-38.47-3.47-77.12,3.19-112.43,18.87-56.51,25.08-100.91,71.71-122.98,129.87,34.72,8.19,58.43,36.7,61.95,71.9,4.32,42.28-20.95,81.41-62.01,90.85,35.89,94.13,127.34,154.37,227.99,149.39l-.02-.02ZM153.43,246.96c-.24-12.67-3.22-24.44-9.24-35.54-9.16-16.9-24.86-29.44-43.72-33.68-29.98-6.74-59.58,5.64-74.5,32.36-14.64,26.23-12.65,60.42,5.56,84.29,14.58,19.12,37.61,28.57,61.47,25.91,37.33-4.17,61.14-36.46,60.43-73.33h0Z"
      fill="currentColor"
    />
    {/* R letter */}
    <path 
      d="M334.85,318.9c2.55,3.3,2.54,6.97-.55,9.35s-7.32,1.38-9.23-2.3l-50.97-66.27h-52.6v65.54c-.19,3.29-2.4,5.59-5.45,5.92-2.51.26-6.55-1.53-6.55-5l-.03-151.17c0-5.19,3.53-9.5,8.9-9.5h60.92c7.47,0,14.4,1.18,21.4,3.29,19.88,6.01,34.49,21.91,33.82,43.33.04,27.48-21.63,42.1-47.04,45.56l47.37,61.24h.01ZM322.58,209.68c-.85-14.46-8.22-23.57-20.94-29.12-7.25-2.96-14.64-3.99-22.56-4.28l-57.61-.05.03,72.72,56.85-.02c9.7-.48,18.7-2.45,27.03-7.2,11.49-6.56,18-18.24,17.19-32.04h.01Z"
      fill="currentColor"
    />
    {/* B letter */}
    <path 
      d="M466.8,246.19c19.56,4.84,35.99,16.09,36.39,38.23.28,15.53-7.82,29-21.65,36.22-9.88,5.16-20.75,8.01-32.21,8.03l-65.7.09c-4.24,0-7.87-3.59-7.87-7.95v-144.82c0-4.82,3.79-8.18,8.34-8.17l59.98.04c25.83.02,51.89,13.63,50.08,42.9-1.11,17.96-11.89,28.95-27.36,35.44h0ZM482.28,209.76c.28-10.93-4.7-20.07-14.06-25.33-6.96-4.06-14.75-5.24-22.98-5.78l-57.55-.06v63.76l53.98-.03c20.18-.11,40.03-9.67,40.61-32.56h0ZM480.7,262.77c-4.6-3.46-9.77-5.57-15.33-7.14-5.94-1.4-11.56-2.05-17.74-2.51l-59.92-.06.03,64.87h60.18c8.03-.13,15.43-1.27,22.75-4.19,6.36-2.69,11.95-6.57,15.83-12.31,7.54-11.17,6.69-29.28-5.78-38.65h-.02Z"
      fill="currentColor"
    />
    {/* i arc */}
    <path 
      d="M549.35,331.47c-1.43,3.96-4.92,5.45-8.4,4.4-3.09-.94-5.58-4.58-4.24-8.24,15.81-43.39,18.21-90.52,7.14-135.36-.91-3.7,1.17-6.89,4.37-7.89s7.33.48,8.28,4.26c11.83,47.23,9.42,96.83-7.14,142.83h-.01Z"
      fill="currentColor"
    />
    {/* i dot */}
    <path 
      d="M539.7,160.13c3.76-1.26,7.34.82,8.41,4.35.95,3.12-.84,6.75-4.1,7.89-3.31,1.17-7.11-.49-8.29-3.95-1.06-3.1.23-7.04,3.98-8.29h0Z"
      fill="currentColor"
    />
    {/* T letter */}
    <path 
      d="M649.44,325.18l-.02-148.1-54.89.05c-3.34,0-5.91-1.02-6.59-4.53-.46-2.36,1.24-6.24,4.68-6.24l123.17-.04c3.64,0,6.26,1.74,6.38,5.03.16,4.27-2.87,5.82-6.69,5.82l-54.1-.06v147.6c0,3.3-3.01,5.45-5.72,5.6-2.49.14-6.23-1.82-6.23-5.13h.01Z"
      fill="currentColor"
    />
  </svg>
)

// Static Nav Logo - Full ORBiT logo from static.svg (includes outer ring + inner elements)
const StaticNavLogo = ({ className = "h-8" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 726.18 496.54" fill="none" xmlns="http://www.w3.org/2000/svg">
    {/* Outer orbital ring */}
    <path 
      d="M318.98,496.54c-27.61,0-54.14-4.42-78.84-13.14l-3.99-1.41-3.53-1.27c-33.29-11.99-64.27-31.95-89.58-57.71-24.3-24.73-43.58-54.98-55.87-87.63-1.27.05-2.53.08-3.78.08-22.4,0-43.31-8.76-58.85-24.66C8.18,294.08-.52,271.56.02,247.39c.17-40.38,26.62-74.95,64.33-84,6.48-1.55,13.41-2.31,21.2-2.31.55,0,1.11,0,1.69.01,17.15-45.42,46.9-84.52,86.17-113.21C213.51,18.58,260.84,2.13,310.29.3c2.31-.2,4.74-.3,7.41-.3s5.53.1,8.17.21l2.34.09c89.94,2.93,171.31,54.55,212.33,134.71,2.82,5.49,1.04,11.75-4.15,14.56-1.61.87-3.3,1.31-5.02,1.31-4.03,0-7.79-2.46-9.82-6.42-17.3-33.75-42.91-62.83-74.06-84.11-31.33-21.4-67.72-34.5-105.22-37.88l-3.78-.34c-6.48-.58-13.07-.88-19.59-.88-31.26,0-61.83,6.53-90.85,19.42-27.69,12.29-52.29,29.66-73.13,51.63-19.88,20.96-35.38,45.12-46.12,71.87,33.42,9.76,56.99,38.42,60.57,74.22,4.47,43.77-20.83,82.54-60.62,93.99,16.85,41.8,45.14,77.25,82.03,102.74,38.05,26.29,82.66,40.19,128.99,40.19h.01c2.9,0,5.83-.06,8.75-.17l2.61-.14c40.2-1.99,79.15-14.59,112.64-36.44,33.43-21.81,60.63-52.3,78.66-88.19,1.95-3.88,5.56-6.19,9.65-6.19,1.25,0,2.48.22,3.68.66,2.77,1.01,5.1,3.31,6.24,6.16,1.08,2.7.99,5.58-.27,8.1-18.5,37.24-46.25,69.45-80.27,93.13-38.72,26.96-84.49,42.21-132.38,44.11-3.37.13-6.77.2-10.13.2ZM84.38,179.93c-23.15,0-43.68,12.01-54.91,32.12-14.08,25.23-11.97,57.34,5.25,79.91,12.01,15.75,30.37,24.78,50.38,24.78h0c2.47,0,4.98-.14,7.46-.42,33.66-3.76,57.57-32.89,56.87-69.28-.23-12.26-3.1-23.28-8.76-33.72-8.81-16.25-23.78-27.79-41.08-31.68-5.05-1.14-10.17-1.71-15.22-1.71Z"
      fill="currentColor"
    />
    {/* Inner orbital with small circle */}
    <path 
      d="M331.34,479c83.46-4.13,157.32-52.48,194.68-126.83,1.71-3.4,5.17-4.74,8.39-3.57,3.14,1.14,5.51,5.2,3.76,8.72-18.2,36.64-45.34,68.21-78.97,91.63-38.39,26.73-83.48,41.54-130.25,43.39-29.69,1.17-59.54-2.85-87.48-12.71l-3.99-1.41-3.51-1.26c-67.14-24.19-119.72-78.57-144.08-145.75-48.96,3.8-86.96-35.63-85.87-83.73.16-37.53,24.27-71.32,61.26-80.2,8.18-1.96,16.29-2.4,24.71-2.12C124,71.89,211.19,7.93,310.53,4.29c6.14-.54,11.8-.2,17.53,0,88.67,2.89,168.52,53.61,208.91,132.53,1.68,3.27,1.02,7.32-2.49,9.22-3.76,2.03-7.58.09-9.38-3.42-35.75-69.74-104.38-117.1-182.48-124.14l-3.78-.34c-38.47-3.47-77.12,3.19-112.43,18.87-56.51,25.08-100.91,71.71-122.98,129.87,34.72,8.19,58.43,36.7,61.95,71.9,4.32,42.28-20.95,81.41-62.01,90.85,35.89,94.13,127.34,154.37,227.99,149.39l-.02-.02ZM153.43,246.96c-.24-12.67-3.22-24.44-9.24-35.54-9.16-16.9-24.86-29.44-43.72-33.68-29.98-6.74-59.58,5.64-74.5,32.36-14.64,26.23-12.65,60.42,5.56,84.29,14.58,19.12,37.61,28.57,61.47,25.91,37.33-4.17,61.14-36.46,60.43-73.33h0Z"
      fill="currentColor"
    />
        ...
        <div className="h-16 flex items-center border-b border-slate-800 px-2">
          <Link href="/dashboard" className="flex items-center text-white h-10 rounded-xl hover:bg-slate-800 transition-colors">
            ...
            <div className="w-12 flex items-center justify-center flex-shrink-0">
              <StaticNavLogo className="w-8 h-8" />
            </div>
          </Link>
        </div>
