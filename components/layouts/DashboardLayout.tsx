...
// Orbit O Mark - Just the orbital ring for collapsed state
const OrbitLogoMark = ({ className = "w-8 h-8" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 400 497" fill="none" xmlns="http://www.w3.org/2000/svg">
    {/* Orbital O with small circle - cropped viewBox to show just O portion */}
    <path 
      d="M331.34,479c83.46-4.13,157.32-52.48,194.68-126.83,1.71-3.4,5.17-4.74,8.39-3.57,3.14,1.14,5.51,5.2,3.76,8.72-18.2,36.64-45.34,68.21-78.97,91.63-38.39,26.73-83.48,41.54-130.25,43.39-29.69,1.17-59.54-2.85-87.48-12.71l-3.99-1.41-3.51-1.26c-67.14-24.19-119.72-78.57-144.08-145.75-48.96,3.8-86.96-35.63-85.87-83.73.16-37.53,24.27-71.32,61.26-80.2,8.18-1.96,16.29-2.4,24.71-2.12C124,71.89,211.19,7.93,310.53,4.29c6.14-.54,11.8-.2,17.53,0,88.67,2.89,168.52,53.61,208.91,132.53,1.68,3.27,1.02,7.32-2.49,9.22-3.76,2.03-7.58.09-9.38-3.42-35.75-69.74-104.38-117.1-182.48-124.14l-3.78-.34c-38.47-3.47-77.12,3.19-112.43,18.87-56.51,25.08-100.91,71.71-122.98,129.87,34.72,8.19,58.43,36.7,61.95,71.9,4.32,42.28-20.95,81.41-62.01,90.85,35.89,94.13,127.34,154.37,227.99,149.39l-.02-.02ZM153.43,246.96c-.24-12.67-3.22-24.44-9.24-35.54-9.16-16.9-24.86-29.44-43.72-33.68-29.98-6.74-59.58,5.64-74.5,32.36-14.64,26.23-12.65,60.42,5.56,84.29,14.58,19.12,37.61,28.57,61.47,25.91,37.33-4.17,61.14-36.46,60.43-73.33h0Z"
      fill="currentColor"
    />
