...
// ORbit Logo Component - Single component with smooth transitions
const OrbitLogo = ({ isExpanded = false }: { isExpanded?: boolean }) => (
  <div className="flex items-center h-8 overflow-hidden">
    {/* Fixed-width container for the O mark */}
    <div className="w-8 h-8 flex-shrink-0 flex items-center justify-center">
      <svg className="w-8 h-8" viewBox="0 0 488 488" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path 
          ...
          fill="currentColor"
          transform="translate(20, 20) scale(0.62)"
        />
        {/* Right arc segment (the "i" curve) */}
        <path 
    ...
    {/* RBT letters container - width and opacity transition */}
    <div 
      className={`flex items-center overflow-hidden transition-all duration-300 ease-out ${
        isExpanded ? 'w-[88px] opacity-100 ml-1' : 'w-0 opacity-0 ml-0'
      }`}
    >
      <svg className="h-6 flex-shrink-0" viewBox="0 0 320 180" fill="none" xmlns="http://www.w3.org/2000/svg">
        {/* R letter */}
        <path 
          d="M52.85,146.9c2.55,3.3,2.54,6.97-.55,9.35s-7.32,1.38-9.23-2.3l-50.97-66.27H-60.5v65.54c-.19,3.29-2.4,5.59-5.45,5.92-2.51.26-6.55-1.53-6.55-5l-.03-151.17c0-5.19,3.53-9.5,8.9-9.5h60.92c7.47,0,14.4,1.18,21.4,3.29,19.88,6.01,34.49,21.91,33.82,43.33.04,27.48-21.63,42.1-47.04,45.56l47.37,61.24h.01ZM40.58,37.68c-.85-14.46-8.22-23.57-20.94-29.12-7.25-2.96-14.64-3.99-22.56-4.28l-57.61-.05.03,72.72,56.85-.02c9.7-.48,18.7-2.45,27.03-7.2,11.49-6.56,18-18.24,17.19-32.04h.01Z"
          fill="currentColor"
          transform="translate(70, 10) scale(0.95)"
        />
        {/* B letter */}
        <path 
          d="M184.8,74.19c19.56,4.84,35.99,16.09,36.39,38.23.28,15.53-7.82,29-21.65,36.22-9.88,5.16-20.75,8.01-32.21,8.03l-65.7.09c-4.24,0-7.87-3.59-7.87-7.95V3.99c0-4.82,3.79-8.18,8.34-8.17l59.98.04c25.83.02,51.89,13.63,50.08,42.9-1.11,17.96-11.89,28.95-27.36,35.44h0ZM200.28,37.76c.28-10.93-4.7-20.07-14.06-25.33-6.96-4.06-14.75-5.24-22.98-5.78l-57.55-.06v63.76l53.98-.03c20.18-.11,40.03-9.67,40.61-32.56h0ZM198.7,90.77c-4.6-3.46-9.77-5.57-15.33-7.14-5.94-1.4-11.56-2.05-17.74-2.51l-59.92-.06.03,64.87h60.18c8.03-.13,15.43-1.27,22.75-4.19,6.36-2.69,11.95-6.57,15.83-12.31,7.54-11.17,6.69-29.28-5.78-38.65h-.02Z"
          fill="currentColor"
          transform="translate(70, 10) scale(0.95)"
        />
        {/* T letter */}
        <path 
          d="M367.44,153.18l-.02-148.1-54.89.05c-3.34,0-5.91-1.02-6.59-4.53-.46-2.36,1.24-6.24,4.68-6.24l123.17-.04c3.64,0,6.26,1.74,6.38,5.03.16,4.27-2.87,5.82-6.69,5.82l-54.1-.06v147.6c0,3.3-3.01,5.45-5.72,5.6-2.49.14-6.23-1.82-6.23-5.13h.01Z"
          fill="currentColor"
...
if (!mounted) {   return (
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      >
        {/* Logo */}
        <div className={`h-16 flex items-center border-b border-white/10 ${isExpanded ? 'px-3' : 'px-3'}`}>
          <Link href="/dashboard" className="flex items-center text-white">
            <OrbitLogo isExpanded={isExpanded} />
          </Link>
        </div>
