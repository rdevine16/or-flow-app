...
// Top panel for staff assignment feature
// Shows toggle, search, role filters, and draggable staff avatars
  ...
  return (
    ...
    `}>
      ...
      <div className="px-4 py-3 flex items-center justify-between">
        ...
        {/* Right side - Search and collapse */}
        {isVisible && (
          <div className="flex items-center gap-3">
            {/* Search Input */}
            <div className="relative">
            ...
            <span className="text-xs text-slate-400 hidden lg:block">⌘K</span>
